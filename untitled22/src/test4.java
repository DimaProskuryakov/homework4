...
public class test4 {
    ...
    public static class AntiCheat {
        public static void run() {
            ...
            antiCheatList.addAll(test4.setMagazine().keySet().stream().map(Object::toString).collect(Collectors.toList()));
            antiCheatList.addAll(test4.setlungsCheck().values().stream().map(Object::toString).collect(Collectors.toList()));
